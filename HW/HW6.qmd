...
textbook-chapters: 5.3, 5.4, 5.6, 6.6
publish-solutions-on: 2024-06-10
---
...
::: {.callout-note}
Please note that in definition 6.20 in your book, there is an apparent error. The formula should be $H(\zeta)=\sum_{n=-\infty}^{\infty} h_n e^{-i \zeta n}$. Note the $n$ in the exponent! The sequence in the first paragraph of page 438 makes this clear, where it says "Here $H(\zeta) = h_0 + h_1 e^{i \zeta} + \dots + h_L e^{i L \zeta}$."
:::
