...
<!-- @idea: fourier_series_and_orthogonality | Fourier series, orthogonality, coefficients -->
<!-- @uses: orthogonal_set, orthonormal_set -->
## The Fourier series
...
<!-- @idea: discrete_fourier_series_and_dft | Discrete Fourier series, DFT matrix -->
<!-- @uses: discrete_time_fourier_transform, discrete_filters -->
...
This defines a matrix that implements the formula for the discrete Fourier coefficients: $F^\prime$ takes the vector of samples $y$ and returns the vector of Fourier coefficients $c$.
...
<!-- @idea: dft_filtering_and_convolution | Filtering, convolution theorem -->
<!-- @uses: discrete_filter, discrete_filters, filter_gain -->
## Filtering
