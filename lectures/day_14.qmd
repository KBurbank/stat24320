...
<!-- @idea: svd_on_tabular_data | SVD on matrices of data, U and V -->

<!-- @uses: left_singular_vector, right_singular_vector, singular_value, singular_value_decomposition, svd, svd_core -->
...
* $u_1$: height and weight increase together
  → overall **body size** direction.
...
<!-- @idea: svd_on_images_and_pca | SVD on images, PCA as truncated SVD -->
<!-- @uses: pca, principal_component, singular_value_decomposition, svd, svd_core -->
<!-- @introduces: principal_component -->
...
<!-- @idea: pca_high_dimensional_data | PCA on high-dimensional data (e.g. faces) -->
