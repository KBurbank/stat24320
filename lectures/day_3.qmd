...
<!-- @idea: diffusion_and_boundary_conditions | Diffusion equation and boundary conditions -->
<!-- @uses: linear_system -->
## Diffusion
...
```
<!-- @idea: reaction_diffusion_solving | Solving and animating reaction–diffusion -->
<!-- @uses: linear_system -->
...
<!-- @idea: matrix_arithmetic_review | Matrix addition, multiplication, linear combination -->
<!-- @uses: linear_combination, linear_system, linear_map, matrix_arithmetic -->
...
<!-- @idea: transformations_scaling_rotation | Scaling, shearing, rotation as transformations -->
<!-- @uses: linear_map, matrix_arithmetic -->
## Scaling 
