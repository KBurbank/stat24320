...
<!-- @idea: mcmc_and_gibbs_sampling | Idea of MCMC -->
<!-- @uses: markov_chain -->
## Idea of MCMC
...
<!-- @idea: rbm_training_and_gibbs | Restricted Boltzmann machine, training, Gibbs -->
<!-- @uses: markov_chain -->
...
<!-- @idea: lu_factorization_saving_work | LU factorization and solving triangular systems -->
<!-- @uses: inverses_and_factorization, linear_system, lu_factorization -->
##
...
![](images/day_6_fig3.jpg){height=100}
...
<!-- @idea: plu_factorization | PLU with row swaps -->
<!-- @uses: inverses_and_factorization, lu_factorization, permutation_matrix, superaugmented_matrix -->
