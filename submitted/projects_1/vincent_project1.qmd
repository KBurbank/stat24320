...
As we discussed, you didn't need to use the normal distribution here. I'd like to see you work this problem including the backwards time method. There was a mistake in the original project description, which I apologize for --  the times should have been 240 and 270, not 180 and 360, so you are trying to find the best D to approximate the values at t=240 and given the values at t=270.
